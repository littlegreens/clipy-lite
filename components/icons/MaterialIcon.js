...
const icons = {
  ...
  smart_display: (
    <svg viewBox="0 0 24 24" fill="currentColor">
      <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-8 10.5v-5l4 2.5-4 2.5z"/>
    </svg>
  ),
  ...
  schedule: (
    <svg viewBox="0 0 24 24" fill="currentColor">
      <path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/><path d="m12.5 7-1 0 0 6 5.25 3.15.75-1.23-4.5-2.67z"/>
    </svg>
  ),
  person: (
    <svg viewBox="0 0 24 24" fill="currentColor">
  ...
  sports_esports: (
    <svg viewBox="0 0 24 24" fill="currentColor">
      <path d="M21.58 16.09l-1.09-7.66C20.21 6.46 18.52 5 16.53 5H7.47C5.48 5 3.79 6.46 3.51 8.43l-1.09 7.66C2.2 17.63 3.39 19 4.94 19h.68c.83 0 1.58-.5 1.9-1.28l.82-2.01c.8-.12 1.72-.12 2.52 0l.82 2.01c.32.78 1.07 1.28 1.9 1.28h.68c1.55 0 2.74-1.37 2.52-2.91zM11 11H9v2H8v-2H6v-1h2V8h1v2h2v1zm4-0.5c-.28 0-.5-.22-.5-.5s.22-.5.5-.5.5.22.5.5-.22.5-.5.5zm2 3c-.28 0-.5-.22-.5-.5s.22-.5.5-.5.5.22.5.5-.22.5-.5.5z"/>
    </svg>
  ),
  menu_book: (
    <svg viewBox="0 0 24 24" fill="currentColor">
